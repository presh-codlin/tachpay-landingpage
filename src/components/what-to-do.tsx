  ...
  return(
    <div id="todo" className="max-w-[1440px] w-full py-[80px] flex gap-[10px] items-center justify-center px-4 min-[380px]:px-[35px] min-[678px]:px-[70px] min-[960px]:px-8 min-[1064px]:px-10 min-[1200px]:px-[80px]">
      <div className="w-full max-w-[1204px] h-[500px] min-[800px]:h-[482px] min-[800px]:px-12 min-[1000px]:px-3 min-[1270px]:px-12 flex items-center overflow-hidden rounded-[40px] bg-[#0B2B26] bg-[url('/noise-texture.png')] backdrop-blur-2xl bg-cover bg-no-repeat bg-blend-overlay">
        ...
        <div className=' flex flex-col gap-[52px] items-start absolute px-6 min-[980px]:px-0 min-[400px]:top-auto min-[980px]:right-6 min-[1000px]:right-6 min-[1030px]:right-12 min-[1120px]:right-8 min-[1126px]:right-6 min-[1171px]:right-10 min-[1200px]:right-8 min-[1271px]:right-12'>
          ...
          <div className='min-[600px]:w-[500px] min-[800px]:w-[580px] min-[980px]:w-[480px] min-[1120px]:w-[580px] flex gap-5 min-[600px]:gap-3 min-[800px]:gap-5 items-center flex-col min-[600px]:flex-row'>
            <button className='w-full py-[16px] min-[800px]:px-[44px] min-[980px]:px-[10px] min-[1120px]:px-[44px] flex gap-[10px] cursor-pointer items-center justify-center rounded-[40px] bg-[#0B2B26] shadow-[inset_2px_4px_12px_0px_#00000066,inset_-1px_-3px_6px_0px_#FFFFFF33] backdrop-[2px_26px_40px_-4px_#33313140]'>
              ...
              <span className='max-w-[122px] flex flex-col items-start gap-2px'>
                ...
                <span className='font-inter font-semibold text-base min-[980px]:text-sm  min-[1120px]:text-base text-[#FFFFFF]'>App Store</span>
              </span>
            </button>
            <button className='w-full py-[16px] px-[45px] min-[600px]:px-0 min-[800px]:px-[44px] min-[980px]:px-[10px] min-[1120px]:px-[44px] cursor-pointer flex gap-[10px] rounded-[40px] bg-[#0B2B26] items-center justify-center shadow-[inset_2px_4px_12px_0px_#00000066,inset_-1px_-3px_6px_0px_#FFFFFF33] backdrop-[2px_26px_40px_-4px_#33313140]'>
              ...
              <span className='flex flex-col items-start gap-2px'>
                ...
                <span className='font-inter font-semibold text-left text-base min-[980px]:text-sm  min-[1120px]:text-base text-[#FFFFFF]'>Google Play Store</span>
              </span>
            </button>
          </div>
        </div>
